...
function PriceRecordsPage() {
  ...
  const filteredConcepts = concepts.filter((concept) =>
    form.categoryId ? concept.categoryId === form.categoryId : true
  );
  ...
  return (
    <section>
      <PageHeader
        title="Historicos"
        description="Captura manual de precios con soporte base para medidas y normalizacion."
      />

      <div className="content-grid">
        <form className="card form-grid" onSubmit={handleSubmit}>
          <h3>Nuevo historico</h3>
