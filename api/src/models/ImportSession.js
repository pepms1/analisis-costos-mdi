...
const importSessionSchema = new mongoose.Schema(
  {
    ...
    detectedSupplierId: { type: mongoose.Schema.Types.ObjectId, ref: "Supplier", default: null },
    detectedWorkId: { type: mongoose.Schema.Types.ObjectId, ref: "Project", default: null },
    detectedYear: { type: Number, default: null },
    detectedDate: { type: Date, default: null },
    detectedContextJson: { type: mongoose.Schema.Types.Mixed, default: null },
